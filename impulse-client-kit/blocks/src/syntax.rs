...
pub fn lang_names() -> Vec<String> {
  REGISTRY.with_borrow_mut(|registry| {
    registry.ensure_builtins();
    registry.langs.iter().flatten().map(|def| def.name.clone()).collect()
  })
}
...
fn builtins() -> Vec<LangDef> {
  ...
  vec![
    ...
    LangDef::new("JavaScript", &["javascript", "js", "jsx", "mjs", "cjs"])
      ...
      .types(&[
        "Array", "Boolean", "Map", "Number", "Object", "Promise", "Set", "String", "Symbol",
      ])
      .builtins(&[
        "console",
        "document",
    ...
    LangDef::new("TypeScript", &["typescript", "ts", "tsx"])
      ...
      .types(&[
        "any", "bigint", "boolean", "never", "number", "object", "string", "symbol", "unknown", "void", "Array", "Map",
        "Partial", "Promise", "Readonly", "Record", "Set",
      ])
    ...
    LangDef::new("Go", &["go", "golang"])
      ...
      .builtins(&[
        "append", "cap", "close", "copy", "delete", "len", "make", "new", "panic", "print", "recover",
      ])
    ...
    LangDef::new("Kotlin", &["kotlin", "kt", "kts"])
      ...
      .types(&[
        "Any", "Boolean", "Byte", "Char", "Double", "Float", "Int", "List", "Long", "Map", "Nothing", "Set", "Short",
        "String", "Unit",
      ])
    ...
    LangDef::new("Shell", &["bash", "sh", "shell", "zsh", "console", "terminal"])
      .keywords(&[
        ...
        "read", "return", "select", "then", "until", "while",
      ])
      .builtins(&[
    ...
    LangDef::new("Ruby", &["ruby", "rb"])
      .keywords(&[
        ...
        "for", "if", "in", "module", "next", "not", "or", "redo", "rescue", "retry", "return", "self", "super", "then",
    ...
    LangDef::new("Typst", &["typst", "typ", "typx"])
      .keywords(&[
        "and", "as", "break", "continue", "else", "for", "if", "import", "in", "include", "let", "not", "or", "return",
        "set", "show", "while",
      ])
      .builtins(&[
        "align",
